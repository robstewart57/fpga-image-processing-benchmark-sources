...
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_maxPixel/In1_DATA
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_maxPixel/In1_ACK
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_maxPixel/In1_SEND
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_maxPixel/Out1_DATA
...
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_normalisedImage/In1_DATA
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_normalisedImage/In1_ACK
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_normalisedImage/In1_SEND

add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_normalisedImage/In2_DATA
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_normalisedImage/In2_ACK
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_normalisedImage/In2_SEND
add wave sim:/ProgNetwork_tb/i_ProgNetwork/i_normalisedImage/Out1_DATA
...
add wave -label maxPixel_In1_full sim:/ProgNetwork_tb/i_ProgNetwork/q_ai_maxPixel_In1/full
add wave -label maxPixel_In1_almost_full sim:/ProgNetwork_tb/i_ProgNetwork/q_ai_maxPixel_In1/almost_full
add wave -label normalisedImage_In1_full sim:/ProgNetwork_tb/i_ProgNetwork/q_ai_normalisedImage_In1/full
add wave -label normalisedImage_In1_almost_full sim:/ProgNetwork_tb/i_ProgNetwork/q_ai_normalisedImage_In1/almost_full
add wave -label normalisedImage_In2_full sim:/ProgNetwork_tb/i_ProgNetwork/q_ai_normalisedImage_In2/full
add wave -label normalisedImage_In2_almost_full sim:/ProgNetwork_tb/i_ProgNetwork/q_ai_normalisedImage_In2/almost_full
